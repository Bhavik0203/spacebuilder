...
import { MapPin, Building, Home, ArrowRight, ChevronDown, ChevronUp } from 'lucide-react';
        ...
        >
            ...
            <div className="absolute inset-0 bg-black/60" />
              <div className="relative z-10 container mx-auto px-6 md:px-12 h-full flex flex-col lg:flex-row justify-between items-start">
                <div className="max-w-4xl pt-20 lg:w-1/2">
                    <h1 className="text-white font-serif leading-tight">
                        <span className="text-6xl  font-bold tracking-wide block mb-4">Crafting Landmarks.</span>
                        <span className="text-6xl  font-bold tracking-wide block">Creating Lifestyles.</span>
                    </h1>

                    <p className="text-xl  text-gray-200 font-sans font-light tracking-wide pl-1 max-w-2xl mt-6">
                ...
                <div className="lg:w-1/2 pt-20 lg:pl-12 lg:flex lg:justify-end">
                    <div className="rounded-lg p-6  lg:w-full max-w-md">
